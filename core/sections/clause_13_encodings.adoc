...
* <<rc_zone-fgjson,FG-SON Zone List>>
...
The FG-JSON requirements class defines support for encoding a DGGS Zone data response according to the https://docs.ogc.org/DRAFTS/21-045.html[FG JSON candidate Standard].
