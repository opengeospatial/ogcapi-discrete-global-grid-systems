...
not necessary for a 3 client working natively with the same DGGRS, this requirement class provides an easy way to readily visualize the response in a variety of tools.
