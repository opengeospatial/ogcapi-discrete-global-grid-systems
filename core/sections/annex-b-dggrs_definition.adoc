...
The schema may change to allow for better description of existing and new classes of DGGH.
...
The DGGH is considered equal-area, although the 12 pentagonal zones at any level occupy 5/6th of the area of hexagonal zones.
...
Through the variable width capability of the tile matrices, this DGGH approximates equal area.
