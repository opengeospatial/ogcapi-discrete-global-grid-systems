...
The Zarr Zone Data encoding requirements class defines support for encoding a DGGS Zone data response according to the https://zarr.readthedocs.io/en/stable/spec/v2.html[Zarr Storage Specification Version 2], packed into a <<ZIPISO,Zip archive>>.
