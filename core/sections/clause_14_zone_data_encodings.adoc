...
[[rc_data-ubjson]]
=== Requirements Class "DGGS-UBJSON Zone data encoding"
...
[[rc_data-dggs-fgjson]]
=== Requirements Class "DGGS-FG-JSON Zone data encoding"
...
=== Requirements Class "DGGS-FG-UBJSON Zone data encoding"
