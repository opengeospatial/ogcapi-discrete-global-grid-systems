...
This first example retrieves elevation data for the GEBCO collection for ISEA3H zone `A2-0-A` at a relative depth of 8 (specified using the `zone-depth` parameter -- the default zone depth is 10, as specified in the
      ...
      "Elevation" : [
         {
            ...
            "data" : [ 24.9531681265927, 21.6738144635267, ...,  3400.2192758791743 ]
         }
      ]
   }
}
...
.Visualization of a CRS84 GeoTIFF response for retrieving data for zone ISEA3H DGGRS https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/A2-0-A[A2-0-A] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry] at a relative depth of 8
...
.Visualization on a 3D Globe of a GeoTIFF response for retrieving data for zone ISEA3H DGGRS https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/A2-0-A[A2-0-A] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry] at a relative depth of 8
...
.Visualization of an ISEA planar projection GeoTIFF response for retrieving data for pentagonal zone ISEA3H DGGRS https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/A2-0-A[A2-0-A] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry] at a relative depth of 8
...
.Visualization of an ISEA planar projection GeoTIFF response for retrieving data for zone ISEA3H DGGRS https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/A0-0-F[A0-0-F] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
...
.Visualization of an ISEA planar projection GeoTIFF response for retrieving data for zone ISEA3H DGGRS https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/B0-5-A[B0-5-A] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
...
.Visualization of a GeoTIFF response in OGC:CRS84 for retrieving data for zone ISEA3H DGGRS https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/A0-0-F[A0-0-F] (odd level 1) of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
...
.Visualization of a GeoTIFF response in OGC:CRS84 for retrieving data for zone ISEA3H DGGRS https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/B0-5-A[B0-5-A] (even level 2) of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
...
----
{
   ...
   "features" : [ {
      ...
      "geometry" : {
         "type" : "Polygon",
         "coordinates" : [
            [ [-77.5187447017182, 68.9629862554185], [-77.5984120016498, 68.9486332726482],
            [-77.6783293369494, 68.9343296358184], [-77.7585214360646, 68.9200930413547],
            [-77.8390143278808, 68.9059451691114], [-77.9198350529017, 68.8919126963785],
            ...
            [-77.5204817666374, 68.9950086109469], [-77.5187447017182, 68.9629862554185] ]
         ]
      },
      "properties" : {
         "Elevation" : 18.5148094925609,
         "zoneID" : "E0-8C1-A"
      }
   }, {
      "type" : "Feature",
...
.Visualization of a GeoJSON point features response for retrieving data for zone ISEA3H DGGRS https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/A2-0-A[A2-0-A] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
image::images/geoJSON-points-elevation.png[width=700,align="center"]

For data of a vector nature, a vector format such as GeoJSON allows to encode zone data resposne in a more compact manner without having to rasterize the data.
...
The following zone data request response and visualization illustrates vector features in Ottawa from OpenStreetMap returned as GeoJSON.
...
----
{
   ...
   "features" : [ {
      ...
      "geometry" : {
         "type" : "LineString",
         "coordinates" :
            [ [-75.7019034306921, 45.4218036153556],
            [-75.7021478619075, 45.4220907968864],
            [-75.7025514751798, 45.4225714864628] ]
      },
      "properties" : {
         "feature::id" : 2305843009218664049,
         "highway" : "service",
...
This representation also addresses the issue of artificial segments, by using a special zone order index value of _0_ to representing coordinates outside of the zone,
...
==== Subsetting zone data

* temporal subsetting -- `datetime=`, `subset=time(...)`
* pressure subsetting -- `subset=pressure(...)`
