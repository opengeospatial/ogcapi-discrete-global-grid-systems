...
[#img_zone_data_geojson_pointsfigure-caption} {counter:figure-num}']
...
Ideally, especially for features spanning a large spatial extent, the features would be clipped to the geometry of the zone for which data is being requested.
