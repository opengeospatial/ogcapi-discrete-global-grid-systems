...
While not achieving the 1% error budget allowed for a DGGH to qualify as being equal area, the use of the https://docs.ogc.org/is/17-083r4/17-083r4.html#toc16[Variable Width 2D Tile Matrix Set] concept allows
...
TIP: The fewer zones approaching the poles based on the https://docs.ogc.org/is/17-083r4/17-083r4.html#toc16[Variable Width 2D Tile Matrix Set] concept are especially noticeable in these visualizations
