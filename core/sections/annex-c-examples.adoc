...
.Visualization of an ISEA planar projection GeoTIFF response for retrieving data for ISEA3H DGGRS zonehttps://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/B0-5-A[B0-5-A] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
...
.Visualization of a GeoTIFF response in OGC:CRS84 for retrieving data for ISEA3H DGGRS zonehttps://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/A0-0-F[A0-0-F] (odd level 1) of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
...
----
{
   ...
   "features" : [ {
      ...
      "geometry" : {
         "type" : "Point",
         "coordinates" : [-78.75, 69.22280465]
      },
      "properties" : {
         "Elevation" : 18.51480949,
         "zoneID" : "E0-8C1-A"
      }
   }, {
      "type" : "Feature",
      ...
      "geometry" : {
         "type" : "Point",
         "coordinates" : [-82.3566945, 68.41764585]
      },
      "properties" : {
         "Elevation" : -0.98992775,
         "zoneID" : "E0-911-A"
      }
   },
   ...
...
.Visualization of a GeoJSON point features response for data retrieved from ISEA3H DGGRS zone https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/A2-0-A[A2-0-A] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
      ...
      "Elevation" : [
         {
            ...
            "data" : [ -497.5576171875, -330.1863299490135, ..., -4571.5036366491877 ]
         }
      ]
   }
}
...
image::images/isea9r-gebco-isea.png[width=700,align="center"]
...
[#img_zone_data_tiff_5x6='{figure-caption} {counter:figure-num}']
.Visualization in the ISEA 5x6 rotated and shared space of a GeoTIFF response for retrieving data for pentagonal ISEA9R DGGRS zone https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA9R/zones/A2-0[A2-0] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry] at a relative depth of 4
image::images/isea9r-gebco-tiff-5x6.png[width=600,align="center"]

[#img_zone_data_tiff_isea='{figure-caption} {counter:figure-num}']
.Visualization of an ISEA planar projection GeoTIFF response for retrieving data for pentagonal ISEA9R DGGRS zone https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA9R/zones/A2-0[A2-0] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry] at a relative depth of 4
image::images/isea9r-gebco-tiff-isea.png[width=600,align="center"]
...
Using centroid points for the geometry of each zone, the response and associated visualization would look like the following:
...
----
{
   ...
   "features" : [ {
      ...
      "geometry" : {
         "type" : "Point",
         "coordinates" : [-77.9427488, 31.8199796]
      },
      "properties" : {
         "Elevation" : -669.8315984701154,
         "zoneID" : "E2-0"
      }
   }, {
      "type" : "Feature",
...
.Visualization of a GeoJSON point features response for data retrieved from ISEA9R DGGRS zone https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA9R/zones/A2-0[A2-0] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
image::images/isea9r-gebco-geojson-points.png[width=700,align="center"]
...
.Visualization in an ISEA planar projection of a GeoJSON feature collection with mixed geometry types for data retrieved from ISEA9R DGGRS zone https://maps.gnosis.earth/ogcapi/collections/osm:ottawa/dggs/ISEA9R/zones/J0-116C0097[J0-116C0097] of https://openstreetmap.org/[OpenStreetMap] (c) OpenStreetMap contributors
image::images/isea9r-osmOttawa-isea.png[width=700,align="center"]
...
image::images/isea9r-neBathymetry-ISEA.png[width=700,align="center"]
...
image::images/isea9r-neBathymetry-Mollweide.png[width=700,align="center"]
