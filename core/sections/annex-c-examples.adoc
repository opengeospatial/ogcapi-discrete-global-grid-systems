...
Following the `[ogc-rel:dggrs-zone-query]` link, specifying these parameters, and negotiating a JSON response response using an `Accept: application/json` header, the client requests from the endpoint:
