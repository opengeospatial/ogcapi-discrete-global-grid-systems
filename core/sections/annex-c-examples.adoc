...
----
{
   ...
   "returnedAreaMetersSquare" : 510065621724088.75,
   "links" : [
...
The DGGS API functionality, as demonstrated in this examples section, is ready to handle any DGGRS, including DGGRS based on these new DGGS types.
