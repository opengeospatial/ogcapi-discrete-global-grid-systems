...
Note that the zones closer to the poles appear larger than zones of the same level closer to the equator, as the Mercator projection enlarges features away from the equator.
