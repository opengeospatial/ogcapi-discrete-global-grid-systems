...
This can result in zones of a lower refinement level being returned than the requested `zone-level`.
A full globe response would thereore always result in the list of all zones of refinement level 0.
In this example, the client will expplicitly set `compact-zones=false`.
