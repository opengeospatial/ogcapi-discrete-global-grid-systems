...
.Visualization of a GeoJSON point features response for data retrieved from ISEA3H zone DGGRS https://maps.gnosis.earth/ogcapi/collections/gebco/dggs/ISEA3H/zones/A2-0-A[A2-0-A] of https://www.gebco.net/news_and_media/gebco_2014_grid.html[GEBCO 2014 bathymetry]
   ...
   "features": [
      {
         ...
         "geometry": {
            ...
            "coordinates": [
               [
                  [ [ -55.637449543389302, 59.870069440756403 ], [ -56.915951548165701, 59.792432298258397 ],
                    [ -58.190262951737999, 59.703354691152001 ], [ -59.459708339296299, 59.603118105290299 ],
                    [ -60.723657456581002, 59.4920474071372 ], [ -61.981528514094002, 59.3705164869166 ],
                    ...
----

[#img_zone_data_geojson_bathymetry='{figure-caption} {counter:figure-num}']
.Visualization in a North polar projection of GeoJSON polygon contours for data retrieved from ISEA3H DGGRS zone https://maps.gnosis.earth/ogcapi/collections/NaturalEarth:physical:bathymetry/dggs/ISEA3H/zones/B0-5-A[B0-5-A] of https://naturalearthdata.com/[Natural Earth] bathymetry contours.
...
.Visualization in an ISEA planar projection of GeoJSON feature polygon contours for data retrieved from ISEA3H DGGRS zone https://maps.gnosis.earth/ogcapi/collections/NaturalEarth:physical:bathymetry/dggs/ISEA3H/zones/B0-5-A[B0-5-A] of https://naturalearthdata.com/[Natural Earth] bathymetry contours.
...
Whereas for LineStrings a single _0_ value is sufficient to represent all outside points between where the line exits and re-enters the zone, for polygon contours a _0_ must be inserted between
each vertex pair of artificial segments following the zone boundary overlapped by the contour.
