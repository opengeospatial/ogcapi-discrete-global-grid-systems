...
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/limit.yaml[`limit`] (clients should rely on hierarchical paging with `parent-zone` and `zone-level` instead) 
