...
| *`/`* | Landing Page +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/responses/common-core/rLandingPage.yaml[Response (OpenAPI)] / https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/schemas/common-core/landingPage.yaml[Schema] |
...
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/responses/common-geodata/rCollectionsList.yaml[Response (OpenAPI)] / https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/schemas/common-geodata/collections.yaml[Schema] |
...
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/responses/common-geodata/rCollection.yaml[Response (OpenAPI)] / https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/schemas/common-geodata/collectionDesc.yaml[Schema] |
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/common-geodata/collectionId-all.yaml[`{collectionId}` path parameter (OpenAPI)]
...
| *`.../dggs`* +
(see <<examples_listing_available_dggrss,Examples C.2>>) | DGGRS List https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/responses/dggs-core/rDGGRSList.yaml[Response (OpenAPI)]  |
| *`.../dggs/{dggrsId}`* +
(see <<examples_retrieving_the_description_of_a_specific_dggrs, Examples C.3>>) | DGGRS Description +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/responses/dggs-core/rDGGRS.yaml[Response (OpenAPI)] / https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/schemas/dggs-core/dggrs.yaml[Schema] |
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/dggrsId.yaml[`{dggrsId}` path parameter (OpenAPI)]
| *`.../dggs/{dggrsId}/zones/{zoneId}`* +
(see <<examples_retrieving_information_for_a_specific_dggrs_zone, Examples C.4>>) | Zone Information +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/responses/dggs-core/rZone.yaml[Response (OpenAPI)] / https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/schemas/dggs-core/zone-info.yaml[Schema] |
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/zoneId.yaml[`{zoneId}` path parameter (OpenAPI)]
3+| *Defined in requirements class <<rc_zone-query,Zone Query>>:*
.3+| *`.../dggs/{dggrsId}/zones`* +
(see <<examples_simple_zone_queries, Examples C.5>> and <<examples_compact_zone_queries, Examples C.6>>) | Zone Query https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/responses/dggs-core/rZonesList.yaml[Response (OpenAPI)] +
(defines a mandatory JSON zone list encoding) |
*Required query parameters:* +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/compact-zones.yaml[`compact-zones`] (see <<examples_simple_zone_queries, Examples C.5>> and <<examples_compact_zone_queries, Examples C.6>>) +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/zone-level.yaml[`zone-level`] (see <<examples_querying_a_particular_refinement_level, Examples C.5.1>>) +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/subset.yaml[`subset`] (see <<examples_querying_for_a_spatio_temporal_subset, Examples C.5.2>>) +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/subset-crs.yaml[`subset-crs`] +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/common-geodata/bbox.yaml[`bbox`]  (see <<examples_querying_for_a_spatio_temporal_subset, Examples C.5.2>>) +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/bbox-crs.yaml[`bbox-crs`] +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/common-geodata/datetime.yaml[`datetime`] (see <<examples_querying_for_a_spatio_temporal_subset, Examples C.5.2>>) +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/parent-zone.yaml[`parent-zone`] (see <<examples_querying_sub_zones_of_a_parent_zone, Examples C.5.4>>) +
 +
Recommended query parameter (optional for server to support): +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/limit-zones.yaml[`limit`] (clients should rely on hierarchical paging with `parent-zone` and `zone-level` instead) 
...
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/filter.yaml[`filter`] (http://www.opengis.net/doc/IS/cql2/1.0[CQL2] expression) +
...
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/profile.yaml[`profile`] +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/geometry.yaml[`geometry`] +

3+| *Defined in requirements class <<rc_data-retrieval,Zone Data Retrieval>>:*
.3+| *`.../dggs/{dggrsId}/zones/{zoneId}/data`* +
(see <<examples_retrieving_data_for_a_dggrs_zone, Examples C.8>> and <<examples_subsetting_and_filtering_zone_data, Examples C.10>>) | Zone Data https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/responses/dggs-core/rZoneData.yaml[Response (OpenAPI)] +
Encoding negotiated with HTTP `Accept:` request header |
Recommended query parameters (optional for server to support): +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/crs.yaml[`crs`]
...
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/zone-depth.yaml[`zone-depth`] +
(see <<examples_requesting_data_at_a_particular_relative_depth, Examples C.9>>) +
 +
*Required by <<rc_data-subsetting,Data subsetting>>:* +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/common-geodata/datetime.yaml[`datetime`] (see <<examples_temporal_subsetting, Examples C.10.1>>) +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/subset.yaml[`subset`] (see <<examples_subsetting_arbitrary_dimensions, Examples C.10.2>>) +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/properties.yaml[`properties`] (see <<examples_field_selection, Examples C.10.3>>) +
   https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/exclude-properties.yaml[`exclude-properties`] +
 +
...
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/geometry.yaml[`geometry`] (see <<examples_geojson_examples,Examples C.8.1.3>>) +
 +
...
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/profile.yaml[`profile`] (see <<examples_dggs_json_fg_examples,Examples C.8.1.4>>) +
 +
Recommended by <<rc_data-png,PNG Data>> (optional for server to support): +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/values-offset.yaml[`values-offset`] +
https://schemas.opengis.net/ogcapi/dggs/1.0/openapi/parameters/dggs-core/values-scale.yaml[`values-scale`] +
|===
