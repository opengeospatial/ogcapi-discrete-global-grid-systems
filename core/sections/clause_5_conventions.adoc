...
Note that the CURIE based on the prefix `[ogc-rel:<relation>]` is also considered equivalent.
For example, `[ogc-rel:dggrs-definition]` corresponds to `https://www.opengis.net/def/rel/ogc/1.0/definition`.
