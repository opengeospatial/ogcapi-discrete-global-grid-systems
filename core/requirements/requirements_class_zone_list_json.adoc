...
part:: If _DGGS Zone Data Retrieval_ is supported, the `links` property SHOULD include an `[ogc-rel:dggrs-zone-data]` link to retrieve data from each of these DGGS zones.
