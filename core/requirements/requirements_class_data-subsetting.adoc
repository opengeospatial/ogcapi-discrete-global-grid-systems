...
====
[%metadata]
label:: /req/data-subsetting/properties
...
part:: If the zone data encodings response can self-describe its list of fields (as with the `shema` property of the DGGS-JSON encoding), the field description SHALL correspond to the requested list of fields.
