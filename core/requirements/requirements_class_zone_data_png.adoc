...
part:: For Implementations supporting Data Custom Depths, request for multiple depths SHALL result in a 4xx error (since the PNG format does not support image pyramids / overview).
