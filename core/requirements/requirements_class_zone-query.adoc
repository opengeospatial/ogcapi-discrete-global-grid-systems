...
part:: The zone listing operation SHALL support a parameter `subset-crs` identifying the CRS in which the `subset` parameter is specified with a URI or safe CURIE.
