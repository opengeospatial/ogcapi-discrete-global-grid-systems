...
Aditionally, to enable DGGS-optimized data encodings, a DGGRS defines a deterministic order for sub-zones whose geometry is at least partially contained within a parent zone of a lower refinement level.
